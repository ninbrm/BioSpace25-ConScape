...
#      buttons: false
    ...
    logo: NINA_logo_sort_txt_engelsk_under.png
    css: lecture.css
    footer: ConScape
...
::: {.column width="50%"}
![](https://methodsblog.com/wp-content/uploads/2017/09/fig1.png)
:::

::: {.column width="50%"}
- habitat patches with a size and/or quality
...
::: {.column width="50%"}
![](https://conscape.org/notebooks/nbk_getting_started_files/figure-html/cell-11-output-1.svg)
:::

::: {.column width="50%"}
- continuous landscapes without clear patches
- pixels are patches
:::
...
Let me try to add some material to the presentation and see if this works
